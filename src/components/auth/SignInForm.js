...
class SignInForm extends Component {
    ...
    signIn = (e) => {
        ...
        e.persist();
        this.props.authStore.signInAsync(request)
            .then(() => {
                if (this.props.authStore.signInStatus === 'success') {
                    this.clear(e);
                    M.toast({
                        html: 'Logged in!',
                    ...
                    setTimeout(() => {
                        ...
                        window.location.href = "https://ebiznes-clientside.azurewebsites.net";
                    }, 2000)
                } else {
                    M.toast({
...
export default inject('signInFormStore', 'authStore')(observer(SignInForm))